...
const mockBuyers: BuyerListing[] = [
  ...
  },
  {
    ...
    timestamp: 'Há 3 dias',
    image: 'https://images.unsplash.com/photo-1585518419759-d87fa40b2e7e?w=400&h=400&fit=crop',
    type: 'buy',
  },
];
...
const mockSellers: SellerListing[] = [
  {
    id: 1,
    product: 'Alface Fresca',
    seller: 'Fazenda Verde',
    location: 'Maputo',
    price: 'MZN 25 / Unidade',
